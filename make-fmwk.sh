...
do
	...
	lipo -create "$configuration_build_dir_32_bits/"*.a -o "$dot_framework_output_dir/$binary_name"
done
...
echo "  <key>Primary configuration</key>" >> "$manifest_file"
echo "  <string>$primary_configuration_name</string>" >> "$manifest_file"
